...
import com.example.eventappp.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun sendOtp(phone: String, otp: String) {
        ...
        val url =
            "https://bulksmsbd.net/api/smsapi?api_key=$bulkSmsApiKey&senderid=$senderId&type=text&number=$number&message=$message"
